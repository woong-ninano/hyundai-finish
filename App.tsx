    ...
    items: [
      {
        ...
        images: [
          "https://images.unsplash.com/photo-1551288049-bbbda536339a?auto=format&fit=crop&q=80&w=800", // 분석 화면
          "https://images.unsplash.com/photo-1586717791821-3f44a563eb4c?auto=format&fit=crop&q=80&w=800"  // 디자인 프로세스
        ]
      },
      {
        title: "데이터로 찾아내는\n나만의 최적 보장",
        ...
        images: [
          "https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&q=80&w=800", // 대시보드
          "https://images.unsplash.com/photo-1551434678-e076c223a692?auto=format&fit=crop&q=80&w=800", // 협업
          "https://images.unsplash.com/photo-1553484771-047a44eee27b?auto=format&fit=crop&q=80&w=800"  // 분석
        ]
      },
      {
        title: "언제 어디서나\n끊김 없는 모바일 경험",
        ...
        images: [
          "https://images.unsplash.com/photo-1512428559083-a4369020473a?auto=format&fit=crop&q=80&w=800", // 모바일 사용
          "https://images.unsplash.com/photo-1522199755839-a2bacb67c546?auto=format&fit=crop&q=80&w=800"  // 모바일 코딩
        ]
      },
      {
        title: "보안은 더 강력하게\n인증은 더 간편하게",
        ...
        images: [
          "https://images.unsplash.com/photo-1563986768609-322da13575f3?auto=format&fit=crop&q=80&w=800", // 보안
          "https://images.unsplash.com/photo-1555066931-4365d14bab8c?auto=format&fit=crop&q=80&w=800"  // 코드 보안
        ]
      }
    ]
  };
      ...
      <section id="hero" className="relative h-screen flex items-center justify-center bg-white overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 text-center z-10">
          ...
          <p className="max-w-2xl mx-auto text-xl md:text-2xl text-gray-400 font-light leading-relaxed">
            ...
            고객의 삶에 가치를 더하는 디지털 플랫폼을 완성했습니다.
          </p>
      ...
      <footer className="bg-white py-24 border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-6 text-center">
          <div className="flex justify-center items-center gap-3 mb-8">
            <div className="w-10 h-10 bg-[#004a99] rounded-full flex items-center justify-center">
          ...
          <div className="flex justify-center gap-8 text-sm font-medium text-gray-400">
            ...
            <span>Design: UI/UX Team</span>
            <span>Dev: Digital Transformation Dept</span>
          </div>
          <p className="text-xs text-gray-300 mt-16 tracking-widest uppercase">© 2024 Hyundai Marine & Fire Insurance Direct.</p>
        </div>
      </footer>
    </div>
  );
